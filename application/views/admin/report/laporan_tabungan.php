...
<body>
    ...
    <div class="judul-lap">
        <span>LAPORAN DATA TABUNGAN</span>
    </div>
    <main>
        <table id="table">
            <thead>
            ...
            <tbody>
                ...
                <?php endforeach; ?>
                <tr>
                    <td colspan="4" style="background-color: rgba(154,154,154,40%);font-weight:bold;">Jumlah Saldo</td>
                    <td style="background-color: rgba(154,154,154,40%);font-weight:bold;">Rp. <?= rupiah($total_saldo['total_setoran'] - $total_saldo['total_penarikan']) ?></td>
                </tr>
                <!-- <?php
                        for ($x = 1; $x <= 30; $x++) { ?>
                    <tr>
